...
export default function page() {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .catch(err => console.error('Error fetching marketupdates:', err))
    }, [token])
    ...
    const handleDelete = async id => {
        ...
        try {
            await axios.delete(
                `https://stockcircle.ethicalden.com/api/markets/market-update/${id}/`,
                {
                    headers: {
                        Authorization: `Token ${token}`
                    }
    ...
    return (
        <div className='tableOverFlow'>
            <Topbar text='Manage Market Update ' DashboardIcon={MdOutlineManageHistory} />
            <div className='ad_section_space'>
                <div className='pb-10'>
                    <h1 className='text-2xl font-semibold mb-0.5 text-gray-800'>
                        Manage Market Update  Post
                    </h1>
                    ...
                    <table className="w-full table-fixed border-collapse text-left text-sm">
                        <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                            <tr>
                                ...
                                <th className="px-4 py-3 font-semibold text-gray-600 border-r border-gray-200 w-[50%]">
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 text-center">
                                        <div className="flex justify-center gap-2">
                                            ...
                                            <Link href={`/dashboard/manage-market-update/${blog.id}`}>
